...
//        moves = whiteBishop.getLegalMoves(board);
//        assertTrue(moves.contains(squares[5][0]));
//        assertFalse(moves.contains(squares[4][-1]));
//    }
//
//    @Test
...
//        assertTrue(moves.contains(squares[5][2]));
//        assertTrue(moves.contains(squares[4][2]));
//    }
//
//    @Test
...
//
//        // Test for en passant
//        Pawn whitePawn = (Pawn) squares[6][1].getOccupyingPiece();
//        whitePawn.move(squares[4][1]);
//        Pawn blackPawn = (Pawn) squares[1][2].getOccupyingPiece();
//        blackPawn.move(squares[3][2]);
//
...
//
//    @Test
//    public void testGameStateRules() {
//        // Test for check
//        squares[6][5].removePiece();
//        Queen whiteQueen = (Queen) squares[7][3].getOccupyingPiece();
//        whiteQueen.move(squares[3][7]);
//
//        // Test for checkmate
//        squares[6][4].removePiece();
//        squares[6][3].removePiece();
//        Queen blackQueen = (Queen) squares[0][3].getOccupyingPiece();
//        blackQueen.move(squares[4][7]);
//    }
//}
